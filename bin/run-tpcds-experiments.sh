...
SPARK_SETTINGS="spark.sql.shuffle.partitions:512,spark.sql.autoBroadcastJoinThreshold:10485760-spark.sql.shuffle.partitions:512,spark.sql.autoBroadcastJoinThreshold:104857600-spark.sql.shuffle.partitions:512,spark.sql.autoBroadcastJoinThreshold:1048576000-spark.sql.shuffle.partitions:256,spark.sql.autoBroadcastJoinThreshold:10485760-spark.sql.shuffle.partitions:256,spark.sql.autoBroadcastJoinThreshold:104857600-spark.sql.shuffle.partitions:256,spark.sql.autoBroadcastJoinThreshold:1048576000-spark.sql.shuffle.partitions:200,spark.sql.autoBroadcastJoinThreshold:10485760-spark.sql.shuffle.partitions:200,spark.sql.autoBroadcastJoinThreshold:104857600-spark.sql.shuffle.partitions:200,spark.sql.autoBroadcastJoinThreshold:1048576000-spark.sql.shuffle.partitions:128,spark.sql.autoBroadcastJoinThreshold:10485760-spark.sql.shuffle.partitions:128,spark.sql.autoBroadcastJoinThreshold:104857600-spark.sql.shuffle.partitions:128,spark.sql.autoBroadcastJoinThreshold:1048576000"
...
SCALE_FACTORS="100" # 200 100 40 20"

CONSTANT_POLICIES="constant:0 constant:1 constant:2 constant:3 constant:4 constant:5 constant:6 constant:7 constant:8 constant:9 constant:10 constant:11"
