...
#SPARK_SETTINGS="spark.sql.shuffle.partitions:512,spark.sql.join.banditJoin:true,spark.sql.join.bandit.shuffleSortHash:both-spark.sql.shuffle.partitions:512,spark.sql.join.banditJoin:true,spark.sql.join.bandit.shuffleSortHash:sort-spark.sql.shuffle.partitions:512,spark.sql.join.banditJoin:true,spark.sql.join.bandit.shuffleSortHash:hash-spark.sql.shuffle.partitions:512,spark.sql.join.banditJoin:false,spark.sql.join.bandit.shuffleSortHash:both-spark.sql.shuffle.partitions:256,spark.sql.join.banditJoin:true,spark.sql.join.bandit.shuffleSortHash:both-spark.sql.shuffle.partitions:256,spark.sql.join.banditJoin:true,spark.sql.join.bandit.shuffleSortHash:sort-spark.sql.shuffle.partitions:256,spark.sql.join.banditJoin:false,spark.sql.join.bandit.shuffleSortHash:both-spark.sql.shuffle.partitions:256,spark.sql.join.banditJoin:true,spark.sql.join.bandit.shuffleSortHash:hash-spark.sql.shuffle.partitions:128,spark.sql.join.banditJoin:true,spark.sql.join.bandit.shuffleSortHash:both-spark.sql.shuffle.partitions:128,spark.sql.join.banditJoin:true,spark.sql.join.bandit.shuffleSortHash:sort-spark.sql.shuffle.partitions:128,spark.sql.join.banditJoin:false,spark.sql.join.bandit.shuffleSortHash:both-spark.sql.shuffle.partitions:128,spark.sql.join.banditJoin:true,spark.sql.join.bandit.shuffleSortHash:hash-spark.sql.shuffle.partitions:64,spark.sql.join.banditJoin:true,spark.sql.join.bandit.shuffleSortHash:both-spark.sql.shuffle.partitions:64,spark.sql.join.banditJoin:true,spark.sql.join.bandit.shuffleSortHash:sort-spark.sql.shuffle.partitions:64,spark.sql.join.banditJoin:false,spark.sql.join.bandit.shuffleSortHash:both-spark.sql.shuffle.partitions:64,spark.sql.join.banditJoin:true,spark.sql.join.bandit.shuffleSortHash:hash-spark.sql.shuffle.partitions:1024,spark.sql.join.banditJoin:true,spark.sql.join.bandit.shuffleSortHash:both-spark.sql.shuffle.partitions:1024,spark.sql.join.banditJoin:true,spark.sql.join.bandit.shuffleSortHash:sort-spark.sql.shuffle.partitions:1024,spark.sql.join.banditJoin:false,spark.sql.join.bandit.shuffleSortHash:both-spark.sql.shuffle.partitions:1024,spark.sql.join.banditJoin:true,spark.sql.join.bandit.shuffleSortHash:hash"
SPARK_SETTINGS="spark.sql.shuffle.partition:512,spark.sql.join.preferSortMergeJoin:true,spark.sql.autoBroadcastJoinThreshold:10485760-spark.sql.shuffle.partition:512,spark.sql.join.preferSortMergeJoin:true,spark.sql.autoBroadcastJoinThreshold:104857600-spark.sql.shuffle.partition:512,spark.sql.join.preferSortMergeJoin:true,spark.sql.autoBroadcastJoinThreshold:1048576000-spark.sql.shuffle.partition:512,spark.sql.join.preferSortMergeJoin:false,spark.sql.autoBroadcastJoinThreshold:10485760-spark.sql.shuffle.partition:512,spark.sql.join.preferSortMergeJoin:false,spark.sql.autoBroadcastJoinThreshold:104857600-spark.sql.shuffle.partition:512,spark.sql.join.preferSortMergeJoin:false,spark.sql.autoBroadcastJoinThreshold:1048576000-spark.sql.shuffle.partition:256,spark.sql.join.preferSortMergeJoin:true,spark.sql.autoBroadcastJoinThreshold:10485760-spark.sql.shuffle.partition:256,spark.sql.join.preferSortMergeJoin:true,spark.sql.autoBroadcastJoinThreshold:104857600-spark.sql.shuffle.partition:256,spark.sql.join.preferSortMergeJoin:true,spark.sql.autoBroadcastJoinThreshold:1048576000-spark.sql.shuffle.partition:256,spark.sql.join.preferSortMergeJoin:false,spark.sql.autoBroadcastJoinThreshold:10485760-spark.sql.shuffle.partition:256,spark.sql.join.preferSortMergeJoin:false,spark.sql.autoBroadcastJoinThreshold:104857600-spark.sql.shuffle.partition:256,spark.sql.join.preferSortMergeJoin:false,spark.sql.autoBroadcastJoinThreshold:1048576000-spark.sql.shuffle.partition:200,spark.sql.join.preferSortMergeJoin:true,spark.sql.autoBroadcastJoinThreshold:10485760-spark.sql.shuffle.partition:200,spark.sql.join.preferSortMergeJoin:true,spark.sql.autoBroadcastJoinThreshold:104857600-spark.sql.shuffle.partition:200,spark.sql.join.preferSortMergeJoin:true,spark.sql.autoBroadcastJoinThreshold:1048576000-spark.sql.shuffle.partition:200,spark.sql.join.preferSortMergeJoin:false,spark.sql.autoBroadcastJoinThreshold:10485760-spark.sql.shuffle.partition:200,spark.sql.join.preferSortMergeJoin:false,spark.sql.autoBroadcastJoinThreshold:104857600-spark.sql.shuffle.partition:200,spark.sql.join.preferSortMergeJoin:false,spark.sql.autoBroadcastJoinThreshold:1048576000-spark.sql.shuffle.partition:128,spark.sql.join.preferSortMergeJoin:true,spark.sql.autoBroadcastJoinThreshold:10485760-spark.sql.shuffle.partition:128,spark.sql.join.preferSortMergeJoin:true,spark.sql.autoBroadcastJoinThreshold:104857600-spark.sql.shuffle.partition:128,spark.sql.join.preferSortMergeJoin:true,spark.sql.autoBroadcastJoinThreshold:1048576000-spark.sql.shuffle.partition:128,spark.sql.join.preferSortMergeJoin:false,spark.sql.autoBroadcastJoinThreshold:10485760-spark.sql.shuffle.partition:128,spark.sql.join.preferSortMergeJoin:false,spark.sql.autoBroadcastJoinThreshold:104857600-spark.sql.shuffle.partition:128,spark.sql.join.preferSortMergeJoin:false,spark.sql.autoBroadcastJoinThreshold:1048576000"
...
#declare -a QUERIES_SETTINGS=("q1:5-q2:5-q4:5-q5:5-q6:5-q10:5" "q11:5-q14a:5-q14b:5-q16:5-q17:5-q24a:5" "q24b:5-q25:5-q29:5-q30:5-q31:5-q32:5" "q35:5-q37:5-q38:5-q39a:5-q39b:5-q40:5-q47:5" "q49:5-q50:5-q54:5-q57:5-q58:5-q59:5-q64:5" "q65:5-q72:5-q74:5-q75:5-q78:5-q80:5-q81:5" "q82:5-q83:5-q84:5-q85:5" "q87:5-q92:5-q93:5-q94:5-q95:5" )
declare -a QUERIES_SETTINGS=("q1:1-q2:1-q4:1-q5:1-q6:1-q10:1-q11:1-q14a:1-q14b:1-q16:1-q17:1-q24a:1-q24b:1-q25:1-q29:1-q30:1-q31:1-q32:1" "q35:1-q37:1-q38:1-q39a:1-q39b:1-q40:1-q47:1-q49:1-q50:1-q54:1-q57:1-q58:1-q59:1-q64:1-q65:1-q72:1-q74:1-q75:1-q78:1-q80:1-q81:1-q82:1-q83:1-q84:1-q85:1-q87:1-q92:1-q93:1-q94:1-q95:1" )
...
CONSTANT_POLICIES="constant:0 constant:1 constant:2 constant:3 constant:4 constant:5 constant:6 constant:7 constant:8 constant:9 constant:10 constant:11 constant:12 constant:13 constant:14 constant:15 constant:16 constant:17 constant:18 constant:19 constant:20 constant:21 constant:22 constant:23"
