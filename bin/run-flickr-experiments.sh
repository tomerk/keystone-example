...
DYNAMIC_POLICIES="lin-ucb:image_rows,image_cols,filter_rows,filter_cols,image_size,fft_cost_model,matrix_multiply_cost_model:true:1.0 linear-thompson-sampling:bias:true:1.0 linear-thompson-sampling:bias,image_rows,image_cols,filter_rows,filter_cols,image_size:true:1.0 linear-thompson-sampling:bias,image_rows,image_cols,filter_rows,image_size:true:1.0 linear-thompson-sampling:bias,image_rows,image_cols,filter_cols,image_size:true:1.0 linear-thompson-sampling:bias,image_rows,image_cols,image_size:true:1.0 gaussian-thompson-sampling:1.0 gaussian-thompson-sampling:2.0 gaussian-thompson-sampling:0.5"
